...
- Handle findings (nonconformities, observations, exceptions) and obligations
- Track audits and compliance posture
...
```json
{
  ...
  "description_for_model": "Access and manage compliance data including organizations, vendors, risks, measures, frameworks, assets, data classifications, findings, obligations, and audits.",
  "auth": {
    "type": "user_http",
