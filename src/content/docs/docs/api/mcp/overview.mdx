...
Model Context Protocol (MCP) is an open standard for connecting AI assistants to external data sources. The Probo MCP Server provides 131 tools for managing:

- Organizations, people, and vendors
- Risk assessments and mitigation
- Compliance measures, controls, and frameworks
- Assets and data classifications
- Findings (nonconformities, observations, exceptions), obligations, and tasks
- Processing activities, DPIAs, and TIAs
- Documents, meetings, and audits
- States of applicability and snapshots

## Available Tools

The Probo MCP Server provides 131 tools organized by resource type. See the complete reference with parameters and examples:

<LinkCard
  title="View All Available Tools"
  description="Complete reference of all 131 tools with parameters, returns, and usage examples"
