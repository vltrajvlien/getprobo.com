...
Model Context Protocol (MCP) is an open standard for connecting AI assistants to external data sources. The Probo MCP Server provides 129 tools for managing:

- Organizations, people, and vendors
- Risk assessments and mitigation
- Compliance measures, controls, and frameworks
- Assets and data classifications
- Nonconformities, obligations, and tasks
...
The Probo MCP Server provides 129 tools organized by resource type. See the complete reference with parameters and examples:

<LinkCard
  title="View All Available Tools"
  description="Complete reference of all 129 tools with parameters, returns, and usage examples"
