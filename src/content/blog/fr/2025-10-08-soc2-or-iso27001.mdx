...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Granulaire : le rapport détaille la conception et l'efficacité de
        contrôles spécifiques.
      </td>
      <td>
        Holistique : le certificat prouve qu'un système conforme est en place,
        pas la performance de contrôles individuels.
      </td>
    </tr>
  </tbody>
</table>
