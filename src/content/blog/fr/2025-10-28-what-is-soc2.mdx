...
Cependant, beaucoup de fondateurs comprennent mal ce qu'est vraiment SOC 2. Ce n'est **pas** une certification que vous accrochez au mur, c'est un _rapport d'attestation_ émis par un auditeur indépendant.
...
- Type II : évalue comment ces contrôles fonctionnent _dans le temps_ (3 à 12 mois).
...
Vous n'avez probablement _pas encore besoin de SOC 2_ si :
